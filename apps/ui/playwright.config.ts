...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      name: "interaction",
      testMatch:
        /(account-profile|accounts-leaders|crawlable-subnet-index|evidence-deep-link|home-landing|indexable-routes|multisig-related-error|offline|sticky-table-header|subnet-dossier-navigation|subnets-directory-controls|subnets-discovery-modes|subnet-profile-trust|validator-profile)\.spec\.ts$/,
