...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      name: "interaction",
      testMatch:
        /(crawlable-subnet-index|evidence-deep-link|home-landing|indexable-routes|multisig-related-error|offline|sticky-table-header|subnet-dossier-navigation|subnets-directory-controls|subnets-discovery-modes)\.spec\.ts$/,
