...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      name: "interaction",
      testMatch:
        /(crawlable-subnet-index|evidence-deep-link|indexable-routes|multisig-related-error|offline|sticky-table-header|subnet-dossier-navigation|subnets-directory-controls)\.spec\.ts$/,
