...
export const TOP_ACTIVE_ACCOUNT_LINK_CLASS =
  "group flex w-full items-center justify-between gap-3 rounded border border-border bg-paper px-3 py-2 text-11 text-ink-strong hover:border-ink/30 hover:text-accent focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/40 min-h-11";
