...
/**
 * /sudo merged into the Chain hub's Governance tab (#8291, part of #8244) and
 * is repointed at the /chain governance section by #11619, which retired that
 * tab into the page below it.
 *
 ...
 * /sudo 301 /chain/governance 301 /chain#governance — which spends a crawl on
 ...
 *
 * The search params are no longer forwarded, and neither is the `view: "sudo"`
 * that used to pin this half of the merged tab: the section shows sudo calls,
 * config changes and runtime upgrades as one feed, so there is no half left to
 * pin and no table for a limit or a call filter to page.
 *
