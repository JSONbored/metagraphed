                    ...
                    <tr key={s.address} className="hover:bg-surface/40">
                      <td className="px-4 py-2 font-mono text-[11px]">
                        <span className="flex items-center gap-1.5">
                          ...
                          <CopyButton value={s.address} label="address" className="-my-4" />
                        </span>
                      </td>
                      <td className="px-4 py-2 text-right font-mono text-[11px] tabular-nums text-ink">
                    ...
                    <tr key={r.address} className="hover:bg-surface/40">
                      <td className="px-4 py-2 font-mono text-[11px]">
                        <span className="flex items-center gap-1.5">
                          ...
                          <CopyButton value={r.address} label="address" className="-my-4" />
                        </span>
                      </td>
                      <td className="px-4 py-2 text-right font-mono text-[11px] tabular-nums text-ink">
                      ...
                      <tr key={s.signer} className="hover:bg-surface/40">
                        <td className="px-4 py-2 font-mono text-[11px]">
                          <span className="flex items-center gap-1.5">
                            ...
                            <CopyButton value={s.signer} label="signer" className="-my-4" />
                          </span>
                        </td>
                        <td className="px-4 py-2 text-right font-mono text-[11px] tabular-nums text-ink">
                    ...
                    <tr key={p.signer} className="hover:bg-surface/40">
                      <td className="px-4 py-2 font-mono text-[11px]">
                        <span className="flex items-center gap-1.5">
                          ...
                          <CopyButton value={p.signer} label="signer" className="-my-4" />
                        </span>
                      </td>
                      <td className="px-4 py-2 text-right font-mono text-[11px] tabular-nums text-ink">
                        ...
                        <td className="px-4 py-2 font-mono text-[11px]">
                          {setter.hotkey ? (
                            <span className="flex items-center gap-1.5">
                              ...
                              <CopyButton value={setter.hotkey} label="hotkey" className="-my-4" />
                            </span>
                          ) : (
                            <span
                ...
                <tr key={`${p.from}-${p.to}`} className="hover:bg-surface/40">
                  ...
                  <td className="px-4 py-2 font-mono text-[11px]">
                    <span className="flex items-center gap-1.5">
                      ...
                      <CopyButton value={p.from} label="address" className="-my-4" />
                    </span>
                  </td>
                  <td className="px-4 py-2 font-mono text-[11px]">
                    <span className="flex items-center gap-1.5">
                      ...
                      <CopyButton value={p.to} label="address" className="-my-4" />
                    </span>
                  </td>
                  <td className="px-4 py-2 text-right font-mono text-[11px] tabular-nums text-ink">
