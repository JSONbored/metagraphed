...
// Entries here are pure gap-fillers: once a provider gets a self-hosted
// registry `logo_url` (apps/ui/public/logos/, priority 1 above), that always
// wins and this map's entry for it becomes unreachable dead weight -- remove
// it here when that happens (allways, gittensor, adtao, bitads, bitrecs,
// blockmachine, cacheon, chutes, compelle, connito, djinn, and targon all
// graduated out this way as their logos were self-hosted).
