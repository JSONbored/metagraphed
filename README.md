...
- **[Swap](https://metagraph.sh/subnets/10)** `SN10` · [site](https://www.taofi.com/pool) · [docs](https://docs.taofi.com/) · [repo](https://github.com/Pareton-ai/pareton)
...
- **[Ralph](https://metagraph.sh/subnets/40)** `SN40` — `distributed-training` `language-models` · [site](https://www.ralphlabs.ai/) · [docs](https://github.com/RalphLabsAI/ralph/blob/main/docs/Ralph-Whitepaper-v1.3.pdf) · [repo](https://github.com/RalphLabsAI/ralph-v2)
- **[Almanac](https://metagraph.sh/subnets/41)** `SN41` — `prediction-markets` · [site](https://almanac.market/) · [repo](https://github.com/corvxai/almanac)
...
- **[Affine](https://metagraph.sh/subnets/120)** `SN120` · [site](https://www.affine.io/) · [repo](https://github.com/AffineFoundation/affine)
- **[sundae_bar](https://metagraph.sh/subnets/121)** `SN121` · [site](https://www.sundaebar.ai/) · [repo](https://github.com/sundae-bar/sb-validator)
