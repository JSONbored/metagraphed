...
export interface components {
    schemas: {
        ...
        /** @description One UTC day of fee/tip totals, averages, and exact per-extrinsic medians. avg_*_tao and median_*_tao are null when the day recorded zero extrinsics. */
        ChainFeeDay: {
