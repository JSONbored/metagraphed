...
// emission share). The bounded D1 read + pure builder live in loadEconomicsTrends
// (src/neuron-history.mjs), shared with the get_economics_trends MCP tool;
// schema-stable (day_count:0, days:[]) on a cold rollup.
