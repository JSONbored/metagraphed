...
// GET /api/v1/accounts/{ss58}/portfolio-history: the wallet's portfolio timeline over a 7d/30d/90d
// window — per snapshot_date the hotkey's footprint (subnet/position/validator/miner counts) and
// standing economics (total stake/emission, overall return), rolled up from the neuron_daily D1
// rollup. The point-in-time companion to /portfolio. Cold/absent store → schema-stable empty series.
