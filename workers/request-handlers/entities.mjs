...
// GET /api/v1/accounts/{ss58}/stake-moves: the account's per-subnet StakeMoved footprint over a
// 7d/30d/90d window — movement count + first/last timestamps per subnet, an HHI concentration of
// where its movement activity is focused, and the dominant subnet. Keyed on the coldkey (the
// account initiating the move), unlike the sibling stake-flow route above. account_events-derived
