...
// Also mitigates spreadsheet formula injection (CWE-1236) by prepending a tab
// character to strings starting with '=', '+', '-', or '@'.
function cellString(value) {
  if (value == null) return "";
  let str;
  if (Array.isArray(value)) {
    str = value.map(cellString).join(";");
 ...
 * Strips path separators and control characters, and escapes double quotes.
 */
