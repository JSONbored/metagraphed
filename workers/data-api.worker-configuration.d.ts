/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.data.jsonc --include-runtime=false workers/data-api.worker-configuration.d.ts` (hash: 4b3e1c09cb4b62359e0632f88b84b6cd)
