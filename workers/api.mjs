...
export async function handleRequest(request, env = {}, ctx = {}) {
  ...
  if (url.pathname === "/api/v1" || url.pathname.startsWith("/api/v1/")) {
    ...
    if (resolved.url.pathname === "/api/v1/chain/onboarding") {
      return handleChainOnboarding(request, env, resolved.url, ctx);
    }
...
function isMainnetOnlyApiPath(pathname) {
  return (
    ...
    pathname === "/api/v1/chain/onboarding" ||
