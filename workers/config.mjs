...
// Per-account stake-movement (re-delegation) footprint: aggregates the account's account_events
// StakeMoved per subnet into a count + concentration scorecard over a 7d/30d/90d window. Keyed on
// the coldkey, unlike the sibling patterns above (StakeMoved is coldkey-initiated).
