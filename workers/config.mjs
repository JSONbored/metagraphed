...
// Per-account stake-move footprint: aggregates the account's account_events StakeMoved per origin
// subnet into a count + concentration scorecard over a 7d/30d/90d window.
