/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc workers/worker-configuration.d.ts` (hash: af94f971eff39a0f5526f6e2840d2cf3)
...
interface __BaseEnv_Env {
	...
	NEON_WRITE_BUFFER: DurableObjectNamespace<import("../dist/api-modules/api.entry").NeonWriteBufferHub>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "D1_EXPORT_REVISIONS" | "D1_STATE_TABLES" | "X402_PAY_TO" | "X402_NETWORK" | "X402_PAY_TO_SOLANA" | "NEON_WRITE_BUFFER_LANES" | "METAGRAPH_CONTRACT_VERSION" | "METAGRAPH_ENABLE_RPC_PROXY" | "METAGRAPH_R2_LATEST_PREFIX" | "METAGRAPH_VALIDATE_RESPONSES" | "METAGRAPH_AUDIT_RESPONSES" | "METAGRAPH_ENABLE_AI" | "METAGRAPH_AI_GATEWAY" | "RAW_CAPTURE_ENABLED" | "ICEBERG_BLOCKS_MAX" | "METAGRAPH_NEURONS_SOURCE" | "POSTHOG_TRACES_SAMPLE_RATE_MCP" | "POSTHOG_USAGE_SAMPLE_RATE" | "POSTHOG_USAGE_SAMPLE_RATES" | "POSTHOG_EXCEPTION_STORM_WINDOW_MS" | "R2_SQL_RATE_LIMIT_COOLDOWN_MS" | "METAGRAPH_SUBNET_HYPERPARAMS_SOURCE" | "METAGRAPH_ACCOUNT_IDENTITY_SOURCE" | "METAGRAPH_SUBNET_IDENTITY_SOURCE" | "METAGRAPH_HEALTH_SOURCE" | "CHAIN_HEAD_POLL_ENABLED" | "CHAIN_HEAD_RPC_URL" | "CHAIN_HEAD_POLL_INTERVAL_MS" | "CHAIN_HEAD_EVENT_COUNT_ENABLED" | "CHAIN_HEAD_AUTHOR_ENABLED" | "TESTNET_CHAIN_HEAD_RPC_URL" | "GITHUB_OAUTH_CLIENT_ID">> {}
}
