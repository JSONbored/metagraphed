/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc workers/worker-configuration.d.ts` (hash: 950418dd46dc8b3cbba58f488ff11b5c)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	D1_STATE_TABLES: "lane_health,attribution_candidates,attribution_sweeps,origin_reachability,compute_declarations,rpc_accounts,github_accounts,api_keys,api_key_blocks,api_key_usage_daily,api_quota_daily,api_usage_rollup,chain_alert_triggers,chain_alert_deliveries,watch_push_subscriptions";
