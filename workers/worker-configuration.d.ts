/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc workers/worker-configuration.d.ts` (hash: ab8e3ee6398154b2637a01b8a2b472a4)
// Runtime types generated with workerd@1.20260730.1 2026-06-06 nodejs_compat
interface __BaseEnv_Env {
	...
	ORIGIN_REACHABILITY: Queue;
	REVENUE_PROBES: Queue;
	...
	NEON_DUAL_WRITE_LANES: "neurons,nominator-positions,account-balances,hotkey-alpha,validator-nominator-counts,subnet-hyperparams,account-identity,subnet-identity,chain-detail,blocks-head,raw-capture-state,subnet-ownership,self-stake";
	...
	CHAIN_FIREHOSE_HUB: DurableObjectNamespace<import("./api.entry").ChainFirehoseHub>;
	MCP_SESSION_HUB: DurableObjectNamespace<import("./api.entry").McpSessionHub>;
	NEON_WRITE_BUFFER: DurableObjectNamespace<import("./api.entry").NeonWriteBufferHub>;
	ALERTER_HUB: DurableObjectNamespace<import("./api.entry").AlerterHub>;
	SUBNET_STATUS_HUB: DurableObjectNamespace<import("./api.entry").SubnetStatusHub>;
	DATA_API: Fetcher /* metagraphed-data-api */;
	REGISTRY_SYNC_API: Fetcher /* metagraphed-registry-sync-api */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./api.entry");
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEON_WRITE_BUFFER_LANES" | "METAGRAPH_CONTRACT_VERSION" | "METAGRAPH_ENABLE_RPC_PROXY" | "METAGRAPH_R2_LATEST_PREFIX" | "NEON_DUAL_WRITE_LANES" | "NEON_SOLE_STORE_TABLES" | "METAGRAPH_VALIDATE_RESPONSES" | "METAGRAPH_ENABLE_AI" | "METAGRAPH_AI_GATEWAY" | "RAW_CAPTURE_ENABLED" | "ICEBERG_BLOCKS_MAX" | "METAGRAPH_BLOCKS_SOURCE" | "METAGRAPH_EXTRINSICS_SOURCE" | "METAGRAPH_ACCOUNT_EVENTS_SOURCE" | "METAGRAPH_NEURONS_SOURCE" | "METAGRAPH_TOP_HOLDERS_SOURCE" | "METAGRAPH_SELF_HEALTH_SOURCE" | "POSTHOG_TRACES_SAMPLE_RATE_MCP" | "POSTHOG_USAGE_SAMPLE_RATE" | "POSTHOG_USAGE_SAMPLE_RATES" | "POSTHOG_EXCEPTION_STORM_WINDOW_MS" | "R2_SQL_RATE_LIMIT_COOLDOWN_MS" | "METAGRAPH_SUBNET_HYPERPARAMS_SOURCE" | "METAGRAPH_ACCOUNT_IDENTITY_SOURCE" | "METAGRAPH_SUBNET_IDENTITY_SOURCE" | "METAGRAPH_RPC_USAGE_SOURCE" | "METAGRAPH_SUBNET_SNAPSHOTS_SOURCE" | "METAGRAPH_HEALTH_SOURCE" | "METAGRAPH_SUBNET_OWNERSHIP_SOURCE" | "CHAIN_HEAD_POLL_ENABLED" | "CHAIN_HEAD_RPC_URL" | "CHAIN_HEAD_POLL_INTERVAL_MS" | "CHAIN_HEAD_EVENT_COUNT_ENABLED" | "CHAIN_HEAD_AUTHOR_ENABLED" | "TESTNET_CHAIN_HEAD_RPC_URL" | "GITHUB_OAUTH_CLIENT_ID">> {}
}
