/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc workers/worker-configuration.d.ts` (hash: 164ef1bee89d0e10d7c6ce3e75907d78)
...
interface __BaseEnv_Env {
	...
	NEON_DUAL_WRITE_LANES: "neurons,nominator-positions,account-balances,hotkey-alpha,validator-nominator-counts,subnet-hyperparams,account-identity,subnet-identity,chain-detail,blocks-head,raw-capture-state,subnet-ownership";
