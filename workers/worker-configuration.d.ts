/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc workers/worker-configuration.d.ts` (hash: 5abf94318f5afa6bf44a1c47e4f145c0)
...
interface __BaseEnv_Env {
	...
	CHAIN_FIREHOSE_HUB: DurableObjectNamespace<import("./api.sentry").ChainFirehoseHub>;
	MCP_SESSION_HUB: DurableObjectNamespace<import("./api.sentry").McpSessionHub>;
	ALERTER_HUB: DurableObjectNamespace<import("./api.sentry").AlerterHub>;
	SUBNET_STATUS_HUB: DurableObjectNamespace<import("./api.sentry").SubnetStatusHub>;
	DATA_API: Fetcher /* metagraphed-data-api */;
	REGISTRY_SYNC_API: Fetcher /* metagraphed-registry-sync-api */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./api.sentry");
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "METAGRAPH_CONTRACT_VERSION" | "METAGRAPH_ENABLE_RPC_PROXY" | "METAGRAPH_R2_LATEST_PREFIX" | "METAGRAPH_VALIDATE_RESPONSES" | "METAGRAPH_ENABLE_AI" | "METAGRAPH_BLOCKS_SOURCE" | "METAGRAPH_EXTRINSICS_SOURCE" | "METAGRAPH_ACCOUNT_EVENTS_SOURCE" | "METAGRAPH_NEURONS_SOURCE" | "METAGRAPH_TOP_HOLDERS_SOURCE" | "METAGRAPH_SUBNET_HYPERPARAMS_SOURCE" | "METAGRAPH_ACCOUNT_IDENTITY_SOURCE" | "METAGRAPH_SUBNET_IDENTITY_SOURCE" | "METAGRAPH_RPC_USAGE_SOURCE" | "METAGRAPH_SUBNET_SNAPSHOTS_SOURCE" | "METAGRAPH_HEALTH_SOURCE" | "METAGRAPH_SUBNET_OWNERSHIP_SOURCE" | "GITHUB_OAUTH_CLIENT_ID">> {}
}
