/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc workers/worker-configuration.d.ts` (hash: 6e6249ca2a8cb8b6be9db80070a87837)
...
interface __BaseEnv_Env {
	...
	METAGRAPH_AUDIT_RESPONSES: "warn";
