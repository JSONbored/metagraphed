/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc workers/worker-configuration.d.ts` (hash: 3256fd0e2f74eecf8ce89ee4bf047719)
// Runtime types generated with workerd@1.20260730.1 2026-06-06 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	...
	AI_RATE_LIMITER_PAID: RateLimit;
	DATA_RATE_LIMITER_COMMUNITY: RateLimit;
	DATA_RATE_LIMITER_PAID: RateLimit;
	STATE_QUERY_RATE_LIMITER_COMMUNITY: RateLimit;
	STATE_QUERY_RATE_LIMITER_PAID: RateLimit;
	WEBHOOK_SUBSCRIPTION_RATE_LIMITER_COMMUNITY: RateLimit;
	WEBHOOK_SUBSCRIPTION_RATE_LIMITER_PAID: RateLimit;
	...
	STATE_QUERY_RATE_LIMITER_KEYED: RateLimit;
	WEBHOOK_SUBSCRIPTION_RATE_LIMITER: RateLimit;
	WEBHOOK_SUBSCRIPTION_RATE_LIMITER_KEYED: RateLimit;
	INTERNAL_SYNC_RATE_LIMITER: RateLimit;
	CHAIN_FIREHOSE_INGEST_RATE_LIMITER: RateLimit;
	FULLNODE_RPC_GUESS_RATE_LIMITER: RateLimit;
	FULLNODE_RPC_RATE_LIMITER: RateLimit;
	FULLNODE_RPC_RATE_LIMITER_GITTENSOR: RateLimit;
	FULLNODE_RPC_RATE_LIMITER_UNLIMITED: RateLimit;
	AI: Ai;
	CF_VERSION_METADATA: WorkerVersionMetadata;
	ASSETS: Fetcher;
	NATIVE_HISTORY_ASSET_RELEASE: "3cfc475d1489014f2ebb7068cb6a0268621f51f399b2e1385d274f7067c46174:213325";
	...
	X402_PAY_TO: "0x224809C91CF942d00ef04b23f7BaB87d5DA5013f";
	X402_NETWORK: "eip155:84532";
	X402_PAY_TO_SOLANA: "EQvVxQ9WShSUjSUj8rod2PFRcQfZ4Ymejx6hJLFMsx87";
	...
	POSTHOG_TRACES_SAMPLE_RATE_MCP: "0.25";
	POSTHOG_USAGE_SAMPLE_RATE: "0.015";
	POSTHOG_USAGE_SAMPLE_RATES: "{\"block-detail\":0.005}";
	...
	CHAIN_FIREHOSE_HUB: DurableObjectNamespace<import("../dist/api-modules/api.entry").ChainFirehoseHub>;
	MCP_SESSION_HUB: DurableObjectNamespace<import("../dist/api-modules/api.entry").McpSessionHub>;
	ALERTER_HUB: DurableObjectNamespace<import("../dist/api-modules/api.entry").AlerterHub>;
	SUBNET_STATUS_HUB: DurableObjectNamespace<import("../dist/api-modules/api.entry").SubnetStatusHub>;
	...
	REGISTRY_SYNC_API: Fetcher /* metagraphed-registry-sync-api */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../dist/api-modules/api.entry");
		durableNamespaces: "ChainFirehoseHub" | "McpSessionHub" | "AlerterHub" | "SubnetStatusHub" | "NeonWriteBufferHub";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NATIVE_HISTORY_ASSET_RELEASE" | "ACCOUNT_HISTORY_ASSET_RELEASE" | "HISTORY_ASSET_RELEASE" | "NATIVE_PROJECTIONS" | "RETAINED_BLOCKS_NETWORKS" | "D1_EXPORT_REVISIONS" | "D1_STATE_TABLES" | "X402_PAY_TO" | "X402_NETWORK" | "X402_PAY_TO_SOLANA" | "METAGRAPH_CONTRACT_VERSION" | "METAGRAPH_ENABLE_RPC_PROXY" | "METAGRAPH_R2_LATEST_PREFIX" | "METAGRAPH_VALIDATE_RESPONSES" | "METAGRAPH_AUDIT_RESPONSES" | "METAGRAPH_ENABLE_AI" | "METAGRAPH_AI_GATEWAY" | "RAW_CAPTURE_ENABLED" | "ICEBERG_BLOCKS_MAX" | "METAGRAPH_NEURONS_SOURCE" | "POSTHOG_TRACES_SAMPLE_RATE_MCP" | "POSTHOG_USAGE_SAMPLE_RATE" | "POSTHOG_USAGE_SAMPLE_RATES" | "POSTHOG_EXCEPTION_STORM_WINDOW_MS" | "METAGRAPH_SUBNET_HYPERPARAMS_SOURCE" | "METAGRAPH_ACCOUNT_IDENTITY_SOURCE" | "METAGRAPH_SUBNET_IDENTITY_SOURCE" | "METAGRAPH_HEALTH_SOURCE" | "CHAIN_HEAD_POLL_ENABLED" | "CHAIN_HEAD_RPC_URL" | "CHAIN_HEAD_POLL_INTERVAL_MS" | "CHAIN_HEAD_EVENT_COUNT_ENABLED" | "CHAIN_HEAD_AUTHOR_ENABLED" | "TESTNET_CHAIN_HEAD_RPC_URL" | "GITHUB_OAUTH_CLIENT_ID">> {}
}
