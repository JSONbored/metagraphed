/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc workers/worker-configuration.d.ts` (hash: d7669f1603ee9db2820e3673440fef31)
...
interface __BaseEnv_Env {
	...
	NEON_READ_LANES: "account_position_daily,neurons,neuron_daily,subnet_snapshots,subnet_hyperparams,account_identity,validator_nominator_counts,subnet_hyperparams_history,account_identity_history,surface_status";
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "ChainFirehoseHub" | "McpSessionHub" | "AlerterHub" | "SubnetStatusHub";
	}
