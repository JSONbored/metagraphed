...
--
-- Name: subnet_identity; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.subnet_identity (
    netuid integer NOT NULL,
...
--
-- Name: subnet_identity_history; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.subnet_identity_history (
    id bigint NOT NULL,
    netuid integer NOT NULL,
    block_number bigint NOT NULL,
    observed_at bigint NOT NULL,
...
--
-- Name: subnet_identity_history_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.subnet_identity_history_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: subnet_identity_history_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.subnet_identity_history_id_seq OWNED BY public.subnet_identity_history.id;
...
--
-- Name: subnet_identity_history id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subnet_identity_history ALTER COLUMN id SET DEFAULT nextval('public.subnet_identity_history_id_seq'::regclass);
...
--
-- Name: subnet_identity_history subnet_identity_history_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subnet_identity_history
    ADD CONSTRAINT subnet_identity_history_pkey PRIMARY KEY (id);

--
-- Name: subnet_identity subnet_identity_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subnet_identity
    ADD CONSTRAINT subnet_identity_pkey PRIMARY KEY (netuid);
...
--
-- Name: subnet_identity_captured_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX subnet_identity_captured_at_idx ON public.subnet_identity USING btree (captured_at DESC);

--
-- Name: subnet_identity_history_netuid_hash_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX subnet_identity_history_netuid_hash_idx ON public.subnet_identity_history USING btree (netuid, identity_hash);

--
-- Name: subnet_identity_history_netuid_observed_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX subnet_identity_history_netuid_observed_idx ON public.subnet_identity_history USING btree (netuid, observed_at DESC, id DESC);

--
-- Name: subnet_identity_history_observed_idx; Type: INDEX; Schema: public; Owner: -
--
