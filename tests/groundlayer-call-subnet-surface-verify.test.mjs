...
//
// The surface is the public no-auth SN20 indexed subnet feed on TaoMarketCap
// (sn-20-taomarketcap-subnet-api, GET
// https://api.taomarketcap.com/public/v1/subnets/20/, JSON, single fixed
// endpoint -- no schema). Live-verified 2026-07-21 to return HTTP 200
// application/json -- an object self-reporting netuid 20 (id, is_active,
...
const registry = JSON.parse(
  readFileSync(
    fileURLToPath(
      new URL("../registry/subnets/groundlayer.json", import.meta.url),
    ),
    "utf8",
  ),
);
...
// A faithful subset of the live SN20 TaoMarketCap subnet feed.
const BODY = {
  id: "20",
  netuid: 20,
  is_active: true,
  mechanism_count: 1,
  latest_snapshot_id: "8667931-20",
};
...
describe("SN20 GroundLayer call_subnet_surface verification (#7058)", () => {
