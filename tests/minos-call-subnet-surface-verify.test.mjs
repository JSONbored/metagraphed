// SN107 (Minos) end-to-end verification for the call_subnet_surface MCP tool
// (metagraphed#7058, MCP execute Phase 1 follow-up #7014/#7215; issue #7118).
// Unlike tests/call-subnet-surface-mcp.test.mjs -- which proves the tool wiring
// with synthetic surfaces -- this file pins SN107's *real* registry surface
// config (registry/subnets/minos.json) to the tool's contract, so a future edit
...
//
// The surface is the public no-auth SN107 indexed subnet feed on TaoMarketCap
// (sn-107-taomarketcap-subnet-api, GET
// https://api.taomarketcap.com/public/v1/subnets/107/, JSON, single fixed
// endpoint -- no schema). Live-verified 2026-07-21 to return HTTP 200
// application/json -- an object self-reporting netuid 107 (id, is_active,
...
const SURFACE_ID = "sn-107-taomarketcap-subnet-api";
const NETUID = 107;
...
// A faithful subset of the live SN107 TaoMarketCap subnet feed.
const BODY = {
  id: "107",
  netuid: 107,
  is_active: true,
  mechanism_count: 1,
  latest_snapshot_id: "8667931-107",
};
...
describe("SN107 Minos call_subnet_surface verification (#7058)", () => {
