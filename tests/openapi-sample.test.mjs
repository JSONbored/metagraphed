...
describe("sampleFromSchema", () => {
  ...
  test("chain axon-removals samples keep removals-per-remover consistent", () => {
    ...
    // A shape whose network lacks removals_per_remover is not an axon-removals artifact and is
    // left untouched (guard branch).
    ...
    const untouchedRemovals = s(notRemovals, "data");
    assert.notEqual(untouchedRemovals.network.removals, 70);
  });
