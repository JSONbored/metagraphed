...
//
// The surface is the public no-auth SN111 indexed subnet feed on TaoMarketCap
// (sn-111-taomarketcap-subnet-api, GET
// https://api.taomarketcap.com/public/v1/subnets/111/, JSON, single fixed
// endpoint -- no schema). Live-verified 2026-07-21 to return HTTP 200
// application/json -- an object self-reporting netuid 111 (id, registered_at,
// is_active, mechanism_count, latest_snapshot). The fixture below mirrors that
...
const registry = JSON.parse(
  readFileSync(
    fileURLToPath(
      new URL("../registry/subnets/oneoneone.json", import.meta.url),
    ),
    "utf8",
  ),
);
...
// A faithful subset of the live SN111 TaoMarketCap subnet feed.
const BODY = {
  id: "111",
  netuid: 111,
  is_active: true,
  mechanism_count: 1,
  latest_snapshot_id: "8667931-111",
};
...
describe("SN111 oneoneone call_subnet_surface verification (#7058)", () => {
