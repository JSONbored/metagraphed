...
//
// The surface is the public no-auth SN103 API health endpoint
// (sn-103-djinn-health, GET https://www.djinn.gg/api/health, JSON, single fixed endpoint -- no schema). Live-verified
...
// A faithful subset of the live https://www.djinn.gg/api/health response body.
...
describe("SN103 SN103 call_subnet_surface verification (#7115)", () => {
  test("the registry surface exists and is configured to be callable", () => {
    ...
    assert.equal(SURFACE.url, "https://www.djinn.gg/api/health");
  ...
  test("end-to-end through the call_subnet_surface MCP tool, resolved by surface id", async () => {
    const catalog = {
      surfaces: [{ ...SURFACE, surface_id: SURFACE.id, netuid: 103 }],
    };
    const deps = {
