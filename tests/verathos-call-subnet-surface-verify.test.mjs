...
//
// The surface is the public no-auth SN96 API health endpoint
// (sn-96-verathos-health, GET https://api.verathos.ai/health, JSON, single fixed endpoint -- no schema). Live-verified
...
// A faithful subset of the live https://api.verathos.ai/health response body.
...
describe("SN96 SN96 call_subnet_surface verification (#7108)", () => {
  test("the registry surface exists and is configured to be callable", () => {
    ...
    assert.equal(SURFACE.url, "https://api.verathos.ai/health");
