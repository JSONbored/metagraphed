// Chain-serving served from a SCHEDULED PROJECTION artifact (#11419).
//
// ## Why this route needed a lane, when twelve siblings already had one
//
// `/chain/serving` is a network-wide aggregate over a 7d/30d window of
...
// reason. This one, its prometheus twin, and the two weights routes did not.
//
// ## What the measurement said, and what it did NOT say
//
// The engine's own metrics (#11436) price the read at 17.4 MiB and 682 R2
...
// them to the SAME `buildChainServing` formatter, which owns ranking, the
 ...
 */
export async function loadChainServingFromArtifact(
