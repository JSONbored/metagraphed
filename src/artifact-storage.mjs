...
export const R2_ONLY_PATTERNS = [
  ...
  /^compare\.json$/,
  // Live provider cross-subnet report (#provider-report): composed at
  // /api/v1/providers/{slug}/report from provider detail + profiles + D1 +
  // economics — never written as a file.
