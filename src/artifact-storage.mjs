...
export const R2_ONLY_PATTERNS = [
  ...
  // Network-wide axon-server leaderboard, computed live from the account_events AxonServed
  // stream at /api/v1/chain/serving/servers — never a file.
  /^chain\/serving\/servers\.json$/,
