...
export const R2_ONLY_PATTERNS = [
  ...
  /^compare\.json$/,
  // Validator comparison (#6325), composed live from the neurons tier at
  // /api/v1/compare/validators -- never written as a file, R2-only for the
  // same reason as compare.json above.
