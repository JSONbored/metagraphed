// Shared live analytics loaders for REST and MCP (#1958).
//
// Pure orchestration over D1 rows + registry projections: the SQL lives here so
// MCP tools and REST handlers share one read path (mirroring loadSubnetTrajectory
// and the #1903 account loaders). Callers inject a `(sql, params) => rows[]`
// runner; a cold/unbound store yields schema-stable empty payloads.
