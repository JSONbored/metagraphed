...
// a store query would always miss. Serving now goes tryDataApiTier -> buildChainAlphaVolume([...]),
// never the store. See src/graphql.ts's chain_alpha_volume and src/mcp-server.ts's
