...
// A trimmed optional string, or null when absent/blank. For open-ended filters an
// enum would wrongly reject (e.g. the account-events `kind`, free-form like REST).
...
export const MCP_TOOLS = [
  ...
  },
  {
    ...
    description:
      ...
      "hotkey is currently registered (with stake and validator permit), and its " +
      "10 most recent events. The natural starting point for 'what is this wallet " +
      "doing across the network'. Computed live from the account_events + neurons " +
      "tiers; a never-seen address returns a schema-stable zero summary, not an error.",
    inputSchema: {
      type: "object",
      properties: {
        ss58: {
  ...
  },
  {
    ...
    description:
      ...
      "with limit (1-1000, default 100) / offset. Use it to trace exactly what a " +
      "wallet has done over time. Events are decoded directly from the chain.",
    inputSchema: {
      type: "object",
      properties: {
        ss58: {
