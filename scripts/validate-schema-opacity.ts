...
const MCP_NOT_YET_TYPED: string[] = [
  ...
  "list_adapter_candidates.candidates[]",
  "list_block_extrinsics.extrinsics[].call_args",
  "list_chain_events.events[].args",
  "list_curation.curation[]",
  "list_endpoint_incidents.incidents[]",
  "list_endpoint_incidents.summary",
  "list_endpoint_pools.pools[]",
  "list_enrichment_evidence.entries[]",
  "list_enrichment_queue.queue[]",
  ...
  "list_gaps.gaps[]",
  "list_profile_completeness.profiles[]",
  "list_profile_completeness.summary",
  "list_profiles.profiles[]",
  "list_provider_endpoints.endpoints[]",
  "list_review_enrichment_targets.targets[]",
  "list_review_gaps.priorities[]",
  "list_rpc_pools.pools[]",
  "list_search.documents[]",
  "list_search_index.documents[]",
  "list_subnet_apis.services[]",
  "list_subnet_candidates.candidates[]",
  "list_subnet_endpoints.endpoints[]",
  "list_subnet_evidence.claims[]",
  "list_subnet_gaps.priorities[]",
  "list_subnet_health.surfaces[]",
  "list_subnet_surfaces.surfaces[]",
