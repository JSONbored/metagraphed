...
export function apiRouteUrl(routePath, date, options = {}) {
  // Shared sample ids/query defaults with docs try-it URLs (#1682, #1652).
  // Live smoke passes a discovered fixture surface id via options.surfaceId.
  const route = substituteRoutePlaceholders(routePath, {
    date,
