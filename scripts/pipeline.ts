...
function checkCommands(): Step[] {
  return [
    ...
    step("validate:api"),
    step("validate:mcp"),
    step("validate:startup-budget"),
    step("validate:mcp-route-map"),
    step("validate:operations"),
    step("validate:type-duplicates"),
    step("validate:nullable-overpromises"),
    step("validate:no-passthrough"),
    step("validate:boundary-casts"),
    step("validate:double-assertions"),
    step("validate:schema-shape-duplicates"),
    ...
    step("validate:lane-topology"),
    step("validate:coverage-scoping"),
    step("validate:lakehouse-types-drift"),
    step("validate:lakehouse-readers"),
